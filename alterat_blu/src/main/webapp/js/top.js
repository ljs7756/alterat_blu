...
if (current_url.indexOf("/selectSending.do") != -1) {
	document.write('				<li class="menu_on"><a href="/selectSending.do?chk_status_all=Y">파일전송</a></li>');
} else {
	document.write('				<li><a href="/selectSending.do?chk_status_all=Y">파일전송</a></li>');
}
if (current_url.indexOf("/tm_monitor.do") != -1) {
	document.write('				<li class="menu_on"><a href="/tm_monitor.do">TM전송현황</a></li>');
} else {
	document.write('				<li><a href="/tm_monitor.do">TM전송현황</a></li>');
}
document.write('			</ul>');
