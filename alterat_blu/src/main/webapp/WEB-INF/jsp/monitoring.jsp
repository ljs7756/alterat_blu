...
function getprogress(idx,j_id){
 ...
 $(function() {
	...
	// 				alert("data=="+data.params.job_progress);
      ...
      if ( (val <= 100 || val == null) && (job_status == "Inprogress" || job_status == "Hold On")){
    	  $("#starttime"+idx).html(starttime);
    	  $("#job_status"+idx).html(job_status); 
    	  $("#targetpath"+idx).html(target_dir+"/"+target_nm); 
    	  $("#control"+idx).html("<a href=\"javascript:fn_cancel_job('"+j_id+"', '"+j_type+"');\"><img src=\"images/btn_cancel.png\" style=\"margin-left: 6px;\"></a>");
