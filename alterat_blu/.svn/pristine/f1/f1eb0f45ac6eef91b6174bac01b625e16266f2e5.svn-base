...
document.write('			<ul>');
document.write('				<li><a href="#">NPS 연계</a></li>');
document.write('				<li><a href="#">프로파일 관리</a></li>');
document.write('				<li><a href="#">와치 폴더</a></li>');
document.write('				<li class="rightno"><a href="#">모니터링</a></li>');
document.write('			</ul>');
