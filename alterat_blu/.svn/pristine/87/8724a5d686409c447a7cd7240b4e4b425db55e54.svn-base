...
<body>
	...
	<form>
		<table border="1">
			<tr>
				<td>
					Source 1 :<input type="text" id="src_01" value="d:\temp3\merge2\M2014032500355.wmv" style="width: 400">
				</td>
			</tr>
			<tr>
				<td>
					Source 2 :<input type="text" id="src_02" value="d:\temp3\merge2\M2014032500355_2.wmv" style="width: 400">
				</td>
			</tr>
            <tr>
                <td>
