	...
	function fn_getFileList(directory) {
		...
		$("#jqxgrid").jqxGrid({
			...
			columns : [ {
				...
				text : 'transcoding',
				datafield : 'transcoding',
				width : '25%',
				editable : false,
				hidden : true
			}, {
				text : 'transfering',
				datafield : 'transfering',
				width : '25%',
				editable : false,
				hidden : true
			}, ]
...
<form id="regist_form">
	<div class="nps_wrap">
		<div class="nps_left">
			...
			<div style="text-align: center; padding: 5px 0 0 0;">
				<p style="text-align: center; padding: 5px 0 0 0;">
					<img id="btn_register" src="/images/btn_add.png"><img id="btn_merge" src="/images/btn_muxing.png">
				</p>
			</div>
		</div>
<!-- 		<div class="nps_right"> -->
...
<!-- 		</div> -->
    <div id='jqxWidget1' style="font-size: 15px; font-family: Verdana; float: left;margin-left:10px;">
<!--         <h3>Customers</h3> -->
