...
<body>
	...
	<form>
		<table border="1">
			<tr>
				<td>
					Source 1 :<input type="text" id="src_01" value="d:\temp3\merge\0000.avi" style="width: 200">
				</td>
			</tr>
			<tr>
				<td>
					Source 2 :<input type="text" id="src_02" value="d:\temp3\merge\0001.avi" style="width: 200">
				</td>
			</tr>
            <tr>
                <td>
                    Source 3 :<input type="text" id="src_03" value="d:\temp3\merge\0002.avi" style="width: 200">
                </td>
            </tr>
            <tr>
                <td>
		...
		<input type="button" id="execute" value="Merge 직업등록" />
	</form>
